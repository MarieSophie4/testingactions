...
/**
 * Component loading in the declaration component
 */
@Component({
  selector: 'broker-declaration',
  templateUrl: './declaration.component.html',
  styleUrls: ['./declaration.component.scss']
})
export class DeclarationComponent extends PagesAbstractDirective implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const script = this.renderExternalScript(this.config.settings.urls.declarationUrl);
